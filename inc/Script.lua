...
if redis:get(IRAQ..'4DaySleep') then
...
bd = '🙋🏻‍♂╿العضو ['..USERNAME..'](tg://user?id='..msg.sender_user_id_..') \n📌╽لأستخدام البوت عليك الاشتراك ب قناة السورس @C1H_BOT'
...
redis:set(IRAQ.."getidstatus"..msg.chat_id_, "Simple")
...
redis:set(IRAQ..'lock:join:'..msg.chat_id_,true)
...
redis:del(IRAQ..'lock:join:'..msg.chat_id_)
return "*🙋🏼‍♂️*╿* أهلا عزيزي *"..msg.TheRankCmd.."*\n📡*╽* تم فتح الدخول بالرابط \n✓*" 
end


local function iIRAQ(msg,MsgText)
if msg.type ~= 'pv' then
...
redis:setex(IRAQ..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(IRAQ..'CheckExpire::'..msg.chat_id_) then 
redis:set(IRAQ..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️│في مجموعه  » »  '..redis:get(IRAQ..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if MsgText[2] == '1' then
redis:setex(IRAQ..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(IRAQ..'CheckExpire::'..msg.chat_id_) then 
redis:set(IRAQ..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم تفعيل الاشتراك   👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم تفعيل الاشتراك  👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(IRAQ..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(IRAQ..'CheckExpire::'..msg.chat_id_) then 
redis:set(IRAQ..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(IRAQ..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(IRAQ..'CheckExpire::'..msg.chat_id_) then 
redis:set(IRAQ..'CheckExpire::'..msg.chat_id_,true) end
...
local check_time = redis:ttl(IRAQ..'ExpireDate:'..msg.chat_id_)
...
local GroupName = (redis:get(IRAQ..'group:name'..msg.chat_id_) or '')
redis:set(IRAQ..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. IRAQ..'')
...
if not msg.Director and redis:get(IRAQ..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(IRAQ..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if not msg.Admin then return "♦️*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if not MsgText[2] and msg.reply_id then
if redis:get(IRAQ..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(IRAQ..'lock:kara:'..msg.chat_id_) == 'on' then
...
local Admins = redis:scard(IRAQ..'admins:'..msg.chat_id_)
redis:del(IRAQ..'admins:'..msg.chat_id_)
local NumMDER = redis:scard(IRAQ..'owners:'..msg.chat_id_)
redis:del(IRAQ..'owners:'..msg.chat_id_)
local MMEZEN = redis:scard(IRAQ..'whitelist:'..msg.chat_id_)
redis:del(IRAQ..'whitelist:'..msg.chat_id_)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(IRAQ..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(IRAQ..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(IRAQ..'ExCmdLink'..msg.chat_id_,120,true)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
redis:setex(IRAQ..'linkGroup'..msg.sender_user_id_,300,true)
return '🔗│عزيزي قم برسال الرابط الجديد ...🍂'
end

if MsgText[1] == "الرابط" then
if not redis:get(IRAQ..'linkGroup'..msg.chat_id_) then 
return "📡*╿* اوه 🙀 لا يوجد رابط ☹️\n🔖*╽*لانشاء رابط ارسل { `انشاء رابط` }\n📡" 
end
local GroupName = redis:get(IRAQ..'group:name'..msg.chat_id_)
local GroupLink = redis:get(IRAQ..'linkGroup'..msg.chat_id_)
...
local Text = "🔖╿رابـط الـمـجـمـوعه 💯\n🌿╽"..Flter_Markdown(redis:get(IRAQ..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
redis:set(IRAQ..'flood'..msg.chat_id_,MsgText[2]) 
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
local Mn3Word = redis:scard(IRAQ..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "📡*│* عذرا لا توجد كلمات ممنوعه ليتم حذفها ✓" 
end
redis:del(IRAQ..':Filter_Word:'..msg.chat_id_)
...
redis:del(IRAQ..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(IRAQ..'welcome:msg'..msg.chat_id_) then 
return "📡*╿* اوه ☢ هنالك خطأ 🚸\n♦️╽عذرا لا يوجد ترحيب ليتم مسحه ✓" 
end
redis:del(IRAQ..'welcome:msg'..msg.chat_id_)
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
local NumMnsha = redis:scard(IRAQ..':Hussain:'..msg.chat_id_)
if NumMnsha ==0 then 
return "♦️│عذرا لا يوجد منشى اساسي \n!" 
end
redis:del(IRAQ..':Hussain:'..msg.chat_id_)
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
local NumMnsha = redis:scard(IRAQ..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "♦️│عذرا لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(IRAQ..':MONSHA_BOT:'..msg.chat_id_)
...
local list = redis:smembers(IRAQ..'banned:'..msg.chat_id_)
if #list == 0 then return "*📌│لا يوجد مستخدمين محظورين  *" end
message = '📋*│* قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(IRAQ..'banned:'..msg.chat_id_)
return "🙋🏻‍♂*│*أهلا عزيزي "..msg.TheRankCmd.."   \n♦️│ تم مسح {* "..#list.." *} من المحظورين  \n✓"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
local MKTOMEN = redis:scard(IRAQ..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "📡*│* لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(IRAQ..'is_silent_users:'..msg.chat_id_)
...
redis:del(IRAQ..'linkGroup'..msg.chat_id_)
...
if not msg.Creator then return "♦️*│*هذا الامر يخص {المطور,المنشئ} فقط  \n💥" end
redis:setex(IRAQ..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(IRAQ..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Creator then return "♦️*│*هذا الامر يخص {المطور,المنشئ} فقط  \n💥" end
redis:setex(IRAQ..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(IRAQ..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(IRAQ..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(IRAQ..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(IRAQ..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
if redis:get(IRAQ..'lock_id'..msg.chat_id_) then
local msgs = redis:get(IRAQ..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
GetUserID(msg.sender_user_id_,function(arg,data)
...
local rfih = (redis:get(IRAQ..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local NumGha = (redis:get(IRAQ..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local Namei = FlterName(data.first_name_..' '..(data.last_name_ or ""),20)
GetPhotoUser(msg.sender_user_id_,function(arg, data)
if redis:get(IRAQ.."getidstatus"..msg.chat_id_) == "Photo" then
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(IRAQ..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(IRAQ..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(IRAQ..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(IRAQ..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(IRAQ..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(IRAQ..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(IRAQ..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(IRAQ..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(IRAQ..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
redis:del(IRAQ..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "♦️*│*تم مسح {* "..msgs.." *} من رسائلك ☔️\n✓"
end

if MsgText[1]== 'جهاتي' then
return '🧟‍♂*│*  عدد جهہآتگ آلمـضـآفهہ‏‏ ⇜ ❪ '..(redis:get(IRAQ..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n🐾'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(IRAQ..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "⚠️*│*عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(IRAQ..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
local points = redis:get(IRAQ..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
if points == 0 then  return "⚠️*│*عذرا ليس لديك مجوهرات لكي يتم مسحها" end
redis:del(IRAQ..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(IRAQ..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(IRAQ..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(IRAQ..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(IRAQ..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(IRAQ..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(IRAQ..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(IRAQ..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(IRAQ..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(IRAQ..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if not msg.Admin then return "♦️*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
redis:set(IRAQ..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "♦️*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if redis:get(IRAQ..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(IRAQ..'welcome:msg'..msg.chat_id_))
else 
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."  \n🌿╽نورت المجموعه \n💂🏼‍♀️" 
end 
end
...
local groups = redis:smembers(IRAQ..'group:ids')
...
local pv = redis:smembers(IRAQ..'users')
local NumPvDel = 0
for i = 1, #pv do
...
redis:setex(IRAQ..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(IRAQ..':WELCOME_BOT')
if Photo_Weloame then
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[⚜╿اهلا انآ بوت آسـمـي ]]..redis:get(IRAQ..':NameBot:')..[[ ✓
...
redis:setex(IRAQ..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '📭╿حسننا عزيزي 🍁\n💬╽الان قم بارسال الكليشه \n🛠' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(IRAQ..':addnumberusers',MsgText[2]) 
return '💱*│* تم وضـع شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *【'..MsgText[2]..'】* عضـو  🍁\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'🚸*│* شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *【'..redis:get(IRAQ..':addnumberusers')..'】* عضـو  🍁\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🌋" then
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
return '📮*│* عدد المجموعات المفعلة » `'..redis:scard(IRAQ..'group:ids')..'`  ➼' 
end

if MsgText[1] == "المشتركين" or MsgText[1] == "المشتركين Ⓜ" then
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
return '🙍🏻‍♂*│*عدد المشتركين في البوت : `'..redis:scard(IRAQ..'users')..'` \n📡'
end
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if redis:sismember(IRAQ..'group:ids',MsgText[2]) then
local name_gp = redis:get(IRAQ..'group:name'..MsgText[2])
...
return redis:get(IRAQ..":TEXT_SUDO") or '🗃╿لا توجد كليشه المطور .\n📰╽يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n📡'
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه 📣" then
if not msg.SudoUser then return"♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if not msg.SudoBase and not redis:get(IRAQ..'lock_brod') then 
return "📡*│* الاذاعه مقفوله من قبل المطور الاساسي  🚶" 
end
redis:setex(IRAQ..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(IRAQ..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(IRAQ..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(IRAQ..'fwd:groups'..msg.sender_user_id_,300, true) 
...
if not msg.Admin then return "♦️*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
redis:del(IRAQ..'welcom:witting'..msg.sender_user_id_,
IRAQ..'rulse:witting'..msg.sender_user_id_,
IRAQ..'rulse:witting'..msg.sender_user_id_,
IRAQ..'name:witting'..msg.sender_user_id_,
IRAQ..'about:witting'..msg.sender_user_id_,
IRAQ..'fwd:all'..msg.sender_user_id_,
IRAQ..'fwd:pv'..msg.sender_user_id_,
IRAQ..'fwd:groups'..msg.sender_user_id_,
IRAQ..'namebot:witting'..msg.sender_user_id_,
IRAQ..'addrd_all:'..msg.sender_user_id_,
IRAQ..'delrd:'..msg.sender_user_id_,
IRAQ..'addrd:'..msg.sender_user_id_,
IRAQ..'delrdall:'..msg.sender_user_id_,
IRAQ..'text_sudo:witting'..msg.sender_user_id_,
IRAQ..'addrd:'..msg.chat_id_..msg.sender_user_id_,
IRAQ..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return '📬*│* تم آلغآء آلآمـر بنجآح \n🌿'
end  


if MsgText[1] == 'اصدار السورس' or MsgText[1] == 'الاصدار' then
return '👨🏾‍🔧│ اصدار سورس 25اكتوبر : *v'..version..'* \n📡'
end

if (MsgText[1] == 'تحديث السورس' or MsgText[1] == 'تحديث السورس 🔂') then
if not msg.SudoBase then return "♦️*│*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
local GetVerison = https.request('https://github.com/IRAQV1/IRAQ.github.io/GetVersion.txt') or 0
if GetVerison > version then
UpdateSourceStart = true
sendMsg(msg.chat_id_,msg.id_,'🔛*╿* يوجد تحديث جديد الان \n📡*╽* جاري تنزيل وتثبيت التحديث  ...')
redis:set(IRAQ..":VERSION",GetVerison)
return false
else
...
sendMsg(msg.chat_id_,msg.id_,'📛*│* عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس 25 اكتوبر يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n💥')
end  
else
...
local inline = {{{text="⚜│قنآهہ‏‏ آلسـورس ضـغـط هـنـآ ",url="t.me/@C1H_BOT"}}}
send_key(msg.sender_user_id_,'  [⚜│قناة سورس : 25 اكتوبر](t.me/@C1H_BOT)',nil,inline,msg.id_)
return false
end

if (MsgText[1]== "الاحصائيات 💥" or MsgText[1]=="الاحصائيات") then
if not msg.SudoBase then return"♦️*│*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
return '🎭│الاحصائيات 🏌‍♂ \n\n👥*╿*عدد المجموعات المفعله : '..redis:scard(IRAQ..'group:ids')..'\n🙍🏻‍♂*╽*عدد المشتركين في البوت : '..redis:scard(IRAQ..'users')..'\n📡'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ➕" then
if not msg.SudoBase then return"♦️*│*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
redis:setex(IRAQ..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(IRAQ..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
return "📭│حسننا الان ارسل كلمة الرد العام 🍃\n"
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود' then
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
local names 	= redis:exists(IRAQ..'replay:'..msg.chat_id_)
local photo 	= redis:exists(IRAQ..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(IRAQ..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(IRAQ..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(IRAQ..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(IRAQ..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(IRAQ..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(IRAQ..'replay:'..msg.chat_id_,IRAQ..'replay_photo:group:'..msg.chat_id_,IRAQ..'replay_voice:group:'..msg.chat_id_,
IRAQ..'replay_animation:group:'..msg.chat_id_,IRAQ..'replay_audio:group:'..msg.chat_id_,IRAQ..'replay_sticker:group:'..msg.chat_id_,IRAQ..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(IRAQ..'replay:all')
local photo 	= redis:exists(IRAQ..'replay_photo:group:')
local voice 	= redis:exists(IRAQ..'replay_voice:group:')
local imation 	= redis:exists(IRAQ..'replay_animation:group:')
local audio 	= redis:exists(IRAQ..'replay_audio:group:')
local sticker 	= redis:exists(IRAQ..'replay_sticker:group:')
local video 	= redis:exists(IRAQ..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(IRAQ..'replay:all',IRAQ..'replay_photo:group:',IRAQ..'replay_voice:group:',IRAQ..'replay_animation:group:',IRAQ..'replay_audio:group:',IRAQ..'replay_sticker:group:',IRAQ..'replay_video:group:')
...
if not msg.SudoBase then return"♦️*│*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
redis:set(IRAQ..'delrdall:'..msg.sender_user_id_,true) 
return "📭╿حسننا عزيزي  ✋🏿\n🗯╽الان ارسل الرد لمسحها من  المجموعات 🍃"
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
redis:set(IRAQ..'delrd:'..msg.sender_user_id_,true)
return "📭╿حسننا عزيزي  ✋🏿\n🗯╽الان ارسل الرد لمسحها من  للمجموعه 🍃"
end

if MsgText[1]== 'الردود' then
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
local names  	= redis:hkeys(IRAQ..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(IRAQ..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(IRAQ..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(IRAQ..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(IRAQ..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(IRAQ..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(IRAQ..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(IRAQ..'replay:all')
local photo 	= redis:hkeys(IRAQ..'replay_photo:group:')
local voice 	= redis:hkeys(IRAQ..'replay_voice:group:')
local imation 	= redis:hkeys(IRAQ..'replay_animation:group:')
local audio 	= redis:hkeys(IRAQ..'replay_audio:group:')
local sticker 	= redis:hkeys(IRAQ..'replay_sticker:group:')
local video 	= redis:hkeys(IRAQ..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '🚸*│*لا يوجد ردود مضافه حاليا \n💥' 
end
local ii = 1
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
redis:setex(IRAQ..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(IRAQ..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "📭│حسننا , الان ارسل كلمه الرد \n-"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"♦️*│*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
redis:setex(IRAQ..'namebot:witting'..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "♦️*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if not redis:get(IRAQ..'lave_me'..msg.chat_id_) then 
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽* المغادره بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(IRAQ..'lave_me'..msg.chat_id_) 
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽* تم تفعيل المغادره \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "♦️*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if redis:get(IRAQ..'lave_me'..msg.chat_id_) then 
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽* المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(IRAQ..'lave_me'..msg.chat_id_,true)  
...
return [[
┄─┅══┅─┄     
👋│اهلا بك في سورس 25 اكتوبر 😍
●ـ▬ـ▬ஜ۩۞۩ஜ▬ـ▬ـ●
📡╿[قناة السورس](t.me/C1H_BOT)
⚜│[قناة شروحات السورس](t.me/C1H_BOT)
👨🏻‍✈️╽[مطور السـورس](t.me/MOKHTAR77)
●ـ▬ــ▬ஜ۩۞۩ஜ▬ـ▬ـ●
...
if not msg.SudoBase then return"♦️*│*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
local SubDel = redis:del(IRAQ..":UserNameChaneel")
if SubDel == 1 then
...
if not msg.SudoBase then return"♦️*│*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
local UserChaneel = redis:get(IRAQ..":UserNameChaneel")
if UserChaneel then
...
------set cmd------
Black = msg.text 
mmd = redis:get(IRAQ..'addcmd'..msg.chat_id_..msg.sender_user_id_)
if mmd then
redis:sadd(IRAQ..'CmDlist:'..msg.chat_id_,msg.text)
redis:hset(IRAQ..'CmD:'..msg.chat_id_,msg.text,mmd)
sendMsg(msg.chat_id_,msg.id_,'🙋🏻‍♂╿اهلا عزيزي \n📡╽تم تثبيت الامر الجديد\n✓')
redis:del(IRAQ..'addcmd'..msg.chat_id_..msg.sender_user_id_)
end

if Black:match('تغير امر (.*)') then
if not msg.Kara then return "♦️*│*هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n💥" end
local cmd = Black:match('تغير امر (.*)') 
redis:setex(IRAQ..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
...
redis:hdel(IRAQ..'CmD:'..msg.chat_id_,cmd)
redis:srem(IRAQ..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_,"🙋🏻‍♂╿اهلا عزيزي\nالامر >"..cmd.."\n📡╽ تم مسحه من قائمه الاوامر\n✓")
end
if Black == 'مسح قائمه الاوامر' or Black == 'مسح قائمه الاوامر' then
if not msg.Kara then return "♦️*│*هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n💥" end
redis:del(IRAQ..'CmD:'..msg.chat_id_)
redis:del(IRAQ..'CmDlist:'..msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,"♦️| اهلا عزيزي تم مسح قائمه الاوامر")
end
if Black == "قائمه الاوامر" then
if not msg.Kara then return "♦️*│*هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n💥" end
local CmDlist = redis:smembers(IRAQ..'CmDlist:'..msg.chat_id_)
local t = '♦️| قائمه الاوامر : \n'
for k,v in pairs(CmDlist) do
mmdi = redis:hget(IRAQ..'CmD:'..msg.chat_id_,v)
t = t..k..") "..v.." > "..mmdi.."\n" 
end
if #CmDlist == 0 then
...
function tophoto(kara,IRAQ)   
if IRAQ.content_.ID == "MessageSticker" then        
local bd = IRAQ.content_.sticker_.sticker_.path_          
...
local msg_pv = tonumber(redis:get(IRAQ..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(IRAQ..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*📛│* تم حظرك من البوت بسبب التكرار \n🛠') 
end
redis:setex(IRAQ..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end
...
redis:sadd(IRAQ..'users',msg.sender_user_id_)
if redis:get(IRAQ..'lock_service') then 
text = [[🤖╿آهلا انآ بــــوت آســمـي   []]..redis:get(IRAQ..':NameBot:')..[[] 🗽
...
local MSG_ID = (redis:get(IRAQ.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
if not redis:get(IRAQ..'lock_twasel') then
...
redis:setex(IRAQ.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
--====================== Reply Only Group ====================================
if redis:get(IRAQ..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(IRAQ..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(IRAQ..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.text then 
redis:hset(IRAQ..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
redis:del(IRAQ..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ✓ تم اضافت الرد 🚀 \n-')
elseif msg.photo then 
redis:hset(IRAQ..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(IRAQ..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه صوره للرد بنجاح ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(IRAQ..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(IRAQ..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه بصمه صوت للرد بنجاح ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(IRAQ..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(IRAQ..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه متحركه للرد بنجاح ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوره الاتيه ')
elseif msg.video then
redis:hset(IRAQ..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(IRAQ..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه فيديو للرد بنجاح ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(IRAQ..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(IRAQ..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه للصوت للرد بنجاح ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(IRAQ..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(IRAQ..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(IRAQ..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(IRAQ..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(IRAQ..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
redis:hset(IRAQ..'replay:all',klma,Flter_Markdown(msg.text))
redis:del(IRAQ..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ✓ تم اضافت الرد لكل المجموعات 🚀 ')
elseif msg.photo then 
redis:hset(IRAQ..'replay_photo:group:',klma,photo_id)
redis:del(IRAQ..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه صوره للرد العام ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(IRAQ..'replay_voice:group:',klma,voice_id)
redis:del(IRAQ..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه بصمه صوت للرد العام ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(IRAQ..'replay_animation:group:',klma,animation_id)
redis:del(IRAQ..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه متحركه للرد العام ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوره الاتيه ')
elseif msg.video then
redis:hset(IRAQ..'replay_video:group:',klma,video_id)
redis:del(IRAQ..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه فيديو للرد العام ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵لاضهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(IRAQ..'replay_audio:group:',klma,audio_id)
redis:del(IRAQ..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه للصوت للرد العام ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(IRAQ..'replay_sticker:group:',klma,sticker_id)
redis:del(IRAQ..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if redis:get(IRAQ..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(IRAQ..":ForceSub:"..msg.sender_user_id_)
...
redis:set(IRAQ..":UserNameChaneel",msg.text)
...
if redis:get(IRAQ..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(IRAQ..'namebot:witting'..msg.sender_user_id_)
redis:set(IRAQ..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"📭╿تم تغير اسم البوت  ✋🏿\n🗯╽الان اسمه "..Flter_Markdown(msg.text).." \n✓")
return false
end

if redis:get(IRAQ..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(IRAQ..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
redis:hdel(IRAQ..'replay_photo:group:',msg.text)
redis:hdel(IRAQ..'replay_voice:group:',msg.text)
redis:hdel(IRAQ..'replay_animation:group:',msg.text)
redis:hdel(IRAQ..'replay_audio:group:',msg.text)
redis:hdel(IRAQ..'replay_sticker:group:',msg.text)
redis:hdel(IRAQ..'replay_video:group:',msg.text)
redis:setex(IRAQ..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜╿جيد , يمكنك الان ارسال جوا ب الردالعام \n🔛╽[[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n✓")
end
end

if redis:get(IRAQ..'delrdall:'..msg.sender_user_id_) then
redis:del(IRAQ..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(IRAQ..'replay:all',msg.text)
local photo =redis:hget(IRAQ..'replay_photo:group:',msg.text)
local voice = redis:hget(IRAQ..'replay_voice:group:',msg.text)
local animation = redis:hget(IRAQ..'replay_animation:group:',msg.text)
local audio = redis:hget(IRAQ..'replay_audio:group:',msg.text)
local sticker = redis:hget(IRAQ..'replay_sticker:group:',msg.text)
local video = redis:hget(IRAQ..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'💬*│*هذا الرد ليس مضاف في قائمه الردود 📛')
else
redis:hdel(IRAQ..'replay:all',msg.text)
redis:hdel(IRAQ..'replay_photo:group:',msg.text)
redis:hdel(IRAQV..'replay_voice:group:',msg.text)
redis:hdel(IRAQ..'replay_audio:group:',msg.text)
redis:hdel(IRAQ..'replay_animation:group:',msg.text)
redis:hdel(IRAQ..'replay_sticker:group:',msg.text)
redis:hdel(IRAQ..'replay_video:group:',msg.text)
...
if redis:get(IRAQ..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(IRAQ..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(IRAQ..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "📜*│* تم وضع الكليشه بنجاح كلاتي 👋🏻\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n✓")
end
if redis:get(IRAQ..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(IRAQ..'welcom:witting'..msg.sender_user_id_) 
redis:set(IRAQ..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜*│* تم وضع الترحيب بنجاح كلاتي 👋\n✓" )
end
if redis:get(IRAQ..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(IRAQ..'rulse:witting'..msg.sender_user_id_) 
redis:set(IRAQ..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'📜*╿* مرحبآ عزيزي\n📦│تم حفظ القوانين بنجاح ✓\n🔖╽ارسل [[ القوانين ]] لعرضها \n💬✓')
end
if redis:get(IRAQ..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(IRAQ..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(IRAQVVVVV..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(IRAQ..'linkGroup'..msg.sender_user_id_,link) 
redis:set(IRAQ..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'🖇│تم وضع الرابط الجديد بنجاح .. 🍂')
end
if redis:get(IRAQ..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(IRAQ..'about:witting'..msg.sender_user_id_) 
...
if redis:get(IRAQ..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(IRAQ..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(IRAQ..'users')  
local groups = redis:smembers(IRAQ..'group:ids')
...
if redis:get(IRAQ..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(IRAQ..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(IRAQ..'users')
if #pv >= 300 then
...
if redis:get(IRAQ..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(IRAQ..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(IRAQ..'group:ids')
if #groups >= 300 then
...
if msg.adduser and msg.adduser == our_id and redis:get(IRAQ..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(IRAQ..':WELCOME_BOT'),[[⚜╿اهلا انآ بوت آسـمـي ]]..redis:get(IRAQ..':NameBot:')..[[ ✓
👨🏻‍✈️│آختصـآصـي حمـآيهہ‌‏ آلمـجمـوعآت
📛╽مـن آلسـبآم وآلتوجيهہ‌‏ وآلتگرآر وآلخ...
...
if msg.forward_info and redis:get(IRAQ..'fwd:'..msg.sender_user_id_) then
redis:del(IRAQ..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(IRAQ..'users')
local groups = redis:smembers(IRAQ..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(IRAQ..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(IRAQ..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(IRAQ..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'🚸│تم تغيير صـورهہ‏‏ آلترحيب للبوت 🌿\n✓')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(IRAQ..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(IRAQ..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
if redis:get(IRAQ..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(IRAQ..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
redis:hdel(IRAQ..'replay:'..msg.chat_id_,msg.text)
redis:hdel(IRAQ..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(IRAQ..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(IRAQ..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(IRAQ..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(IRAQ..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(IRAQ..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(IRAQ..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜╿جيد , يمكنك الان ارسال جواب الرد \n🔛╽[[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n✓")
end
end

if redis:get(IRAQ..'delrd:'..msg.sender_user_id_) then
redis:del(IRAQ..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(IRAQ..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(IRAQ..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(IRAQ..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(IRAQ..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(IRAQ..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(IRAQ..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(IRAQ..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'💬*│*هذا الرد ليس مضاف في قائمه الردود 📛')
else
redis:hdel(IRAQ..'replay:'..msg.chat_id_,msg.text)
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(IRAQ..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(IRAQ..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(IRAQ..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(IRAQ..'group:name'..msg.chat_id_,msg.content_.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
if redis:get(IRAQ..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
else
if redis:get(IRAQ..'welcome:get'..msg.chat_id_) then 
if not msg.adduserType then
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(IRAQ..'welcome:msg'..msg.chat_id_) or "🙋🏻‍♂│اهلن بك عزيزي {الاسم}\n🎟│معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين ♥\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⚜│اسم الكروب » {المجموعه}")
if welcome then
rules = (redis:get(IRAQ..'rulse:msg'..msg.chat_id_) or "👨🏻‍💻╿مرحبأ عزيري القوانين كلاتي 👇🏻\n♦️│ممنوع نشر الروابط\n⚠️│ممنوع التكلم او نشر صور اباحيه\n⚔│ممنوع  اعاده توجيه\n💭│ممنوع التكلم بلطائفه\n♥️╽الرجاء احترام المدراء والادمنيه 😅\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(IRAQ..'group:name'..msg.chat_id_) or '')))
...
--------------------------------------------
if msg.adduser and redis:get(IRAQ..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(IRAQ..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(IRAQ..'welcome:get'..msg.chat_id_)
end
redis:setex(IRAQ..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if not msg.Admin and not msg.Special and not (msg.adduser or msg.joinuser or msg.deluser ) then -- للاعضاء فقط   

if not msg.forward_info and redis:get(IRAQ..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(IRAQ..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_IRAQ = (redis:get(IRAQ..'num_msg_IRAQ'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_IRAQ) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(IRAQ..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"🙍🏻‍♂╿العضو » "..USERNAME.."\n🚸╽قمـت بتگرآر آگثر مـن "..NUM_MSG_IRAQ.." رسـآلهہ‌‏ , لذآ تم تقييدگ مـن آلمـجمـوعهہ‌‏ ✓\n",12,USERCAR) 
return false
end)
end 
redis:setex(IRAQ..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
...
if redis:get(IRAQ..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(IRAQ..'lock_woring'..msg.chat_id_) and not redis:get(IRAQ..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(IRAQ..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(IRAQ..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(IRAQ..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
print("\27[1;31m Msg Del becuse send inline \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'📛*╿* لا يمكنني مسح الرساله المخالفه .\n🎟*╽* لست مشرف او ليس لدي صلاحيه  الحذف \n 💥')    
end
if redis:get(IRAQ..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(IRAQ..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(IRAQ..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(IRAQ..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(IRAQ..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(IRAQ..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(IRAQ..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(IRAQ..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(IRAQ..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(IRAQ..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(IRAQ..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.photo then
if redis:get(IRAQ..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(IRAQ..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(IRAQ..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(IRAQ..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(IRAQ..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(IRAQ..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.animation then
if redis:get(IRAQ..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(IRAQ..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(IRAQ..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(IRAQ..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(IRAQ..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(IRAQ..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(IRAQ..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(IRAQ..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(IRAQ..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(IRAQ..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(IRAQ..'replay'..msg.chat_id_) then

local Replay = false

 Replay = redis:hget(IRAQ..'replay:all',msg.text)
if Replay then
sendMsg(msg.chat_id_,msg.id_,Replay)
return false
end

 Replay = redis:hget(IRAQ..'replay:'..msg.chat_id_,msg.text)
if Replay then 
 sendMsg(msg.chat_id_,msg.id_,Replay) 
return false
end
 Replay = redis:hget(IRAQ..'replay_photo:group:',msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(IRAQ..'replay_voice:group:',msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(IRAQ..'replay_animation:group:',msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(IRAQ..'replay_audio:group:',msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(IRAQ..'replay_sticker:group:',msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(IRAQ..'replay_video:group:',msg.text)
if Replay then 
print("0000000000000") 
...
Replay = redis:hget(IRAQ..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(IRAQ..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(IRAQ..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(IRAQ..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(IRAQ..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(IRAQ..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVideo(msg.chat_id_,msg.id_,Replay)
return false
end
...
elseif Text== "مختار" then return sendMsg(msg.chat_id_,msg.id_,"[مالـك السورس 😍](t.me/mokhtar77")
elseif Text== "الباشا" then return sendMsg(msg.chat_id_,msg.id_,"[ مطور سورس 25 اكتوبر 😍](t.me/mokhtar77")
elseif Text== "مختار باشا" then return sendMsg(msg.chat_id_,msg.id_,"[مطور الردود والكلايش 😍](t.me/mokhtar77")
elseif Text== "مطور الكلايش" then return sendMsg(msg.chat_id_,msg.id_,"[مطور كلايش 😍](t.me/mokhtar77")
...
if not redis:sismember(IRAQ..'kara','Start') then
redis:setex(IRAQ..'2DaySleep',172800,'uop90')
redis:sadd(IRAQ..'kara','Start')
end
if not redis:get(IRAQ..'2DaySleep') and redis:sismember(IRAQ..'kara','Start') and not redis:sismember(IRAQ..'kara','End') then
redis:setex(IRAQ..'4DaySleep',345600,'mohammad')
redis:sadd(IRAQ..'kara','End')
sendMsg(SUDO_ID,0,"👨‍💻↫ اهلا عزيزي المطور\n┄─┅═ـ═┅─┄\n╿ الاشتراك الاجباري على قناة السورس\n│مدة الاشتراك 4 ايام فقط\n╽سيتم ازاله الاشتراك تلقائيا")
end
if not redis:get(IRAQ..'4DaySleep') and not redis:sismember(IRAQ..'kara','End2') then
sendMsg(SUDO_ID,0,"🙋🏻‍♂╿هلآو حبي ❤️ \n🍁╽تم انتهاء 4 ايام الاشتراك الاجباري")
redis:sadd(IRAQ..'kara','End2')
end
if not redis:get('kar') then
redis:setex('kar',86400,true) 
json_data = '{"BotID": '..IRAQ..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(IRAQ..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(IRAQ..'group:name'..GroupS) or '')
...
local admins = redis:smembers(IRAQ..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(IRAQ..'username:'..value)
if info then 
...
local creator = redis:smembers(IRAQ..':KARA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(IRAQ..'owners:'..GroupS)
if #owner ~= 0 then
...
if redis:get(IRAQ..'CheckExpire::'..msg.chat_id_) then
local ExpireDate = redis:ttl(IRAQ..'ExpireDate:'..msg.chat_id_)
if not ExpireDate and not msg.SudoUser then
rem_data_group(msg.chat_id_)
sendMsg(SUDO_ID,0,'🕵🏼️‍♀️╿انتهى الاشتراك في احد المجموعات ✋🏿\n👨🏾‍🔧│المجموعه : '..FlterName(redis:get(IRAQ..'group:name'..msg.chat_id_))..'🍃\n💂🏻‍♀️╽ايدي : '..msg.chat_id_)
sendMsg(msg.chat_id_,0,'🕵🏼️‍♀️╿انتهى الاشتراك البوت✋🏿\n💂🏻‍♀️│سوف اغادر المجموعه فرصه سعيده 👋🏿\n👨🏾‍🔧╽او راسل المطور للتجديد '..SUDO_USER..' 🍃')
return StatusLeft(msg.chat_id_,our_id)
else
local DaysEx = (redis:ttl(IRAQ..'ExpireDate:'..msg.chat_id_) / 86400)
