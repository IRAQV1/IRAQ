...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(IRAQ..":NameBot:")
...
var = 'مطور اساسي 👨🏻‍✈️' 
elseif redis:sismember(IRAQ..':SUDO_BOT:',UserID) then
var = 'مطور ثانوي 👨🏽‍💻' 
elseif redis:sismember(IRAQ..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي👷🏽' 
elseif redis:sismember(IRAQ..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء 👷🏽' 
elseif redis:sismember(IRAQ..'owners:'..ChatID,UserID) then
var = 'مدير البوت 👨🏼‍⚕️' 
elseif redis:sismember(IRAQ..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت 👨🏼‍🎓' 
elseif redis:sismember(IRAQ..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز ⭐️' 
else
var = 'فقط عضو 🙍🏼‍♂️' 
end
...
if msg.edited then
redis:incr(IRAQ..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(IRAQ..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(IRAQ..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(IRAQ..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(IRAQ..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(IRAQ..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(IRAQ..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(IRAQ..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(IRAQ..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(IRAQ..':SUDO_BOT:')
message = '👨🏽‍💻*│* قائمه الـمـطـوريـن : \n\n`👨‍✈️│مطور اساسي`**\n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*┄─┅══┅─┄ *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n📛 *"
else
for k,v in pairs(list) do
local info = redis:hgetall(IRAQ..'username:'..v)
local count = redis:scard(IRAQ..'mtwr_count'..v)
...
local monsha = redis:smembers(IRAQ..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*┄─┅══┅─┄ \n\n📋│ قائمه المدراء :*\n\n'
local list = redis:smembers(IRAQ..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(IRAQ..'admins:'..msg.chat_id_)
...
local list = redis:smembers(IRAQ..'whitelist:'..msg.chat_id_)
...
if redis:sismember(IRAQ..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(IRAQ..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(IRAQ..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(IRAQ..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(IRAQ..'gban_users')
...
local list = redis:smembers(IRAQ..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(IRAQ..':Filter_Word:'..msg.chat_id_,word) then 
return  "📝*│*الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع✓️" 
else
redis:sadd(IRAQ..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(IRAQ..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(IRAQ..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(IRAQ..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(IRAQ..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(IRAQ..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(IRAQ..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local creator = redis:smembers(IRAQ..':MONSHA_BOT:'..GroupS)
if #creator ~= 0 then
...
local list = redis:smembers(IRAQ..'group:ids')
message = '📋*│*قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(IRAQ..'group:name'..v)
if info then 
...
redis:del(
IRAQ..'group:add'..id_group,
IRAQ..'lock_link'..id_group, 
IRAQ..'lock_id'..id_group,
IRAQ..'lock_spam'..id_group, 
IRAQ..'lock_webpage'..id_group,
IRAQ..'lock_markdown'..id_group,
IRAQ..'lock_flood'..id_group,
IRAQ..'lock_bots'..id_group,
IRAQ..'mute_forward'..id_group,
IRAQ..'mute_contact'..id_group,
IRAQ..'mute_location'..id_group,
IRAQ..'mute_document'..id_group,
IRAQ..'mute_keyboard'..id_group,
IRAQ..'mute_game'..id_group,
IRAQ..'mute_inline'..id_group,
IRAQ..'lock_username'..id_group,
IRAQ..'num_msg_IRAQ'..id_group,
IRAQ..'replay'..id_group
)
redis:srem(IRAQ..'group:ids',id_group)
end
...
redis:hset(IRAQ..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(IRAQ..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(IRAQ..'group:add'..msg.chat_id_) then  return '🎗*│*المجموعه بالتأكيد ✓️ تم تفعيلها' end
...
IRAQGetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(IRAQ..':addnumberusers') or 0)
...
local lock_service = redis:get(IRAQ..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(IRAQ..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(IRAQ..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
IRAQ..'group:add'..msg.chat_id_,true,
IRAQ..'lock_link'..msg.chat_id_,true, 
IRAQ..'lock_id'..msg.chat_id_,true,
IRAQ..'lock_spam'..msg.chat_id_,true,
IRAQ..'lock_webpage'..msg.chat_id_,true,
IRAQ..'lock_markdown'..msg.chat_id_,true,
IRAQ..'lock_flood'..msg.chat_id_,true,
IRAQ..'lock_bots'..msg.chat_id_,true,
IRAQ..'mute_forward'..msg.chat_id_,true,
IRAQ..'mute_contact'..msg.chat_id_,true,
IRAQ..'mute_location'..msg.chat_id_,true,
IRAQ..'mute_document'..msg.chat_id_,true,
IRAQ..'mute_keyboard'..msg.chat_id_,true,
IRAQ..'mute_game'..msg.chat_id_,true,
IRAQ..'mute_inline'..msg.chat_id_,true,
IRAQ..'lock_username'..msg.chat_id_,true,
IRAQ..'num_msg_IRAQ'..msg.chat_id_,5, 
IRAQ..'replay'..msg.chat_id_,true
)

redis:sadd(IRAQ..'group:ids',msg.chat_id_) 
redis:sadd(IRAQ..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(IRAQ..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(IRAQ..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(IRAQ..'group:add'..msg.chat_id_) then return '🛠*│* المجموعه بالتأكيد ✓️ تم تعطيلها' end  
...
elseif redis:sismember(IRAQ..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"🏌‍♂*│*لا يمكنك تقييد المطور الثانوي\n🛠") 
elseif redis:sismember(IRAQ..':MONSHA_BOT:'..ChatID,UserID) then 
...
if redis:sismember(IRAQ..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(IRAQ..'username:'..UserID,'username',Resolv)
redis:sadd(IRAQ..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تمت ترقيته ليصبح منشىء في البوت \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(IRAQ..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(IRAQ..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(IRAQ..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(IRAQ..'username:'..UserID,'username',Resolv)
redis:sadd(IRAQ..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تمت ترقيته ليصبح منشىء اساسي في البوت \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(IRAQ..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(IRAQ..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(IRAQ..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(IRAQ..'username:'..UserID, 'username', Resolv)
redis:sadd(IRAQ..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(IRAQ..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(IRAQ..'whitelist:'..ChatID,UserID)
...
if redis:sismember(IRAQ..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(IRAQ..'username:'..UserID, 'username', Resolv)
redis:sadd(IRAQ..'owners:'..ChatID,UserID)
...
if redis:sismember(IRAQ..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(IRAQ..'username:'..UserID, 'username', Resolv)
redis:sadd(IRAQ..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(IRAQ..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(IRAQ..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(IRAQ..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(IRAQ..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(IRAQ..'msgs:'..UserID..':'..ChatID) or 1
...
redis:hset(IRAQ..'username:'..UserID, 'username', Resolv)
redis:sadd(IRAQ..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم حظره  \n✓️',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(IRAQ..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم بالتأكيد الغاء حظره  \n✓️',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم الغاء حظره \n✓️',17,USERCAR) 
end
redis:srem(IRAQ..'banned:'..ChatID,UserID)
...
elseif redis:sismember(IRAQ..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"🏌‍♂*│*لا يمكنك كتم المطورالثانوي\n🛠") 
elseif redis:sismember(IRAQ..':MONSHA_BOT:'..ChatID,UserID) then 
...
if redis:sismember(IRAQ..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم بالتأكيد كتمه  \n✓️',17,USERCAR) 
end
redis:hset(IRAQ..'username:'..UserID, 'username', Resolv)
redis:sadd(IRAQ..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم كتمه \n✓️',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(IRAQ..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم بالتاكيد الغاء كتمه  \n✓️',17,USERCAR) 
end
redis:srem(IRAQ..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم الغاء كتمه  \n✓️',17,USERCAR) 
end
...
redis:srem(IRAQ..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم الغاء حظره العام \n✓️',17,USERCAR) 
end
...
elseif redis:sismember(IRAQ..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"🏌‍♂*│*لا يمكنك طرد المطورالثانوي\n🛠") 
elseif redis:sismember(IRAQ..':MONSHA_BOT:'..ChatID,UserID) then 
...
if redis:sismember(IRAQ..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد مطور \n✓️',17,USERCAR) 
end
redis:hset(IRAQ..'username:'..UserID, 'username', Resolv)
redis:sadd(IRAQ..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم ترقيته ليصبح مطور \n✓️',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(IRAQ..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد ليس مطور \n✓️',17,USERCAR) 
end
redis:srem(IRAQ..':SUDO_BOT:',UserID)
...
return sendMsg(ChatID,MsgID,"🏌‍♂*│*لا يمكنك تقييد المطور الاساسي\n🛠") 
elseif redis:sismember(IRAQ..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"🏌‍♂*│*لا يمكنك تقييد المطورالثانوي\n🛠") 
elseif redis:sismember(IRAQ..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"🏌‍♂*│*لا يمكنك تقييد المنشئ\n🛠") 
elseif redis:sismember(IRAQ..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"🏌‍♂*│*لا يمكنك تقييد المدير\n🛠") 
...
redis:hset(IRAQ..'username:'..UserID, 'username', UserName)
redis:sadd(IRAQ..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,'🙍🏻‍♂*╿*العضو » ❪ '..UserName..' ❫\n🎟*│*الايدي » ❪ `'..UserID..'` ❫\n💯*╽*تمت ترقيته ليصبح منشىء في البوت \n✓️')
end
...
if redis:sismember(IRAQ..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'🙍🏻‍♂*╿*العضو » ❪ '..UserName..' ❫\n🎫*│*الايدي » ❪ `'..UserID..'` ❫\n💯*╽*تم بالتأكيد حظره \n✓️') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
Restrict(ChatID,UserID,1)
redis:hset(IRAQ..'username:'..UserID, 'username', Resolv)
redis:sadd(IRAQ..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم تقييد آلعضـو بنجآح \n✓️',17,USERCAR) 
end 
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
redis:srem(IRAQ..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم فگ تقييد آلعضـو بنجآح \n✓️',17,USERCAR) 
end
if cmd == "setwhitelist" then
if redis:sismember(IRAQ..'whitelist:'..ChatID,UserID) then 
...
if cmd == "dn_sudo" then
if not redis:sismember(IRAQ..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'🙍🏻‍♂*╿*العضو » '..USERNAME..' \n🎫*│* الايدي » (`'..UserID..'`)\n💯*╽*انه بالتأكيد ليس مطور \n✓') end
redis:srem(IRAQ..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم تنزيله من المطورين \n✓️',17,USERCAR) 
end
...
if redis:get(IRAQ..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(IRAQ..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(IRAQ..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(IRAQ..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*👮🏾*` اعدادات المجموعه :` \n"
.."\n📝╿التعديل «» "..(redis:get(IRAQ..'lock_edit'..msg.chat_id_) or 'false')
.."\n🔗│الروابط «» "..(redis:get(IRAQ..'lock_link'..msg.chat_id_) or 'false')
.."\n⃣│التاك «» "..(redis:get(IRAQ..'lock_tag'..msg.chat_id_) or 'false')
.."\n🐞│المعرفات «» "..(redis:get(IRAQ..'lock_username'..msg.chat_id_) or 'false')
.."\n💱│التكرار «» "..(redis:get(IRAQ..'lock_flood'..msg.chat_id_) or 'false')
.."\n📑│الكلايش «» "..(redis:get(IRAQ..'lock_spam'..msg.chat_id_) or 'false')
.."\n🌐│الويب «» "..(redis:get(IRAQ..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⚜️│الماركدوان «» "..(redis:get(IRAQ..'lock_markdown'..msg.chat_id_) or 'false')
.."\n🏌🏻│بالطرد البوتات «» "..(redis:get(IRAQ..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n🤖│البوتات «» "..(redis:get(IRAQ..'lock_bots'..msg.chat_id_) or 'false')
.."\n➕│عدد التكرار «» "..(redis:get(IRAQ..'num_msg_IRAQ'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n🎬│`اعدادات الوسائط :`\n"
.."\n*🎑│*المتحركه «» "..(redis:get(IRAQ..'mute_gif'..msg.chat_id_) or 'false')
.."\n💭│الدردشه «» "..(redis:get(IRAQ..'mute_text'..msg.chat_id_) or 'false')
.."\n◽️│الانلاين «» "..(redis:get(IRAQ..'mute_inline'..msg.chat_id_) or 'false')
.."\n🎮│الالعاب «» "..(redis:get(IRAQ..'mute_game'..msg.chat_id_) or 'false')
.."\n🏞│الصور «» "..(redis:get(IRAQ..'mute_photo'..msg.chat_id_) or 'false')
.."\n🎥│الفيديو «» "..(redis:get(IRAQ..'mute_video'..msg.chat_id_) or 'false')
.."\n🎙│البصمات «» "..(redis:get(IRAQ..'mute_audio'..msg.chat_id_) or 'false')
.."\n🔉│الصوت «» "..(redis:get(IRAQ..'mute_voice'..msg.chat_id_) or 'false')
.."\n🎎│الملصقات «» "..(redis:get(IRAQ..'mute_sticker'..msg.chat_id_) or 'false')
.."\n📞│الجهات «» "..(redis:get(IRAQ..'mute_contact'..msg.chat_id_) or 'false')
.."\n💱│التوجيه «» "..(redis:get(IRAQ..'mute_forward'..msg.chat_id_) or 'false')
.."\n🌐│الموقع «» "..(redis:get(IRAQ..'mute_location'..msg.chat_id_) or 'false')
.."\n🗂│الملفات «» "..(redis:get(IRAQ..'mute_document'..msg.chat_id_) or 'false')
.."\n🔅│الاشعارات «» "..(redis:get(IRAQ..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n🔒│الكيبورد «» "..(redis:get(IRAQ..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⚒│*`اعدادات اخرى : `"
.."\n\n*🙋🏼‍♂️│*الترحيب «» "..welcomex
.."\n*💬│*الردود «» "..replayx
...
.."\n*🌐│*الويب «» "..(redis:get(IRAQ..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*⚜️│*الماركدوان «» "..(redis:get(IRAQ..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*🏌🏻│*البوتات بالطرد «» "..(redis:get(IRAQ..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*🤖│*البوتات «» "..(redis:get(IRAQ..'lock_bots'..msg.chat_id_) or 'false')
.."\n*➕╽*عدد التكرار «» "..(redis:get(IRAQ..'num_msg_IRAQ'..msg.chat_id_) or 'false')
.."\n┄─┅═ـ═┅─┄\n*👨‍💻*اعدادات التقـييد :\n"
.."\n*💢╿*التقييد بالتوجيه «» "..(redis:get(IRAQ..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*📸│*التقييد بالصور «» "..(redis:get(IRAQ..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*🔗│*التقييد بالروابط «» "..(redis:get(IRAQ..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*🎉│*التقييد بالمتحركه «» "..(redis:get(IRAQ..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*🎥╽*التقييد الفيديو «» "..(redis:get(IRAQ..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
